  ...
  public function renderSearchArea($flagButtonText = false)
  {
    ...
    if ($this->searchKey) {
      ...
      <div class="right" >
        ...
        <button class="wgt-button splitted wgtac_search" ><i class="fa fa-search" ></i></button><button
            class="wcm wcm_ui_dropform wgt-button append"
            id="wgt-search-{$this->context}-{$this->searchKey}-con"
            title="Open the extended search"
          ><i class="fa fa-angle-down" ></i><var>{"size":"big"}</var></button>
          ...
          <div>
              ...
              <h2>Search</h2>
              <div class="right" ><a class="wgt-button icon-only wgtac_close_overlay" href="#close-search" ><i class="fa fa-times" ></i></a></div>
            </div>
...
{$htmlFilters}
              ...
              <div class="half right" >
              	...
              	<ul class="wgt-tree" >
              		<li>
              			<button class="wgt-button" ><i class="fa fa-filter" ></i> Urgent</button>
              			| <button class="wgt-button" ><i class="fa fa-times" ></i></button>
              		</li>
              		<li><button class="wgt-button wgt-active" ><i class="fa fa-filter" ></i> Send by Joe</button>
              			| <button class="wgt-button" ><i class="fa fa-times" ></i></button>
              		</li>
              		<li><button class="wgt-button" ><i class="fa fa-filter" ></i> Project X 2012</button>
              			| <button class="wgt-button" ><i class="fa fa-times" ></i></button>
              		</li>
              	</ul>
              </div>
            ...
            <div class="do-clear small wgt-border-bottom" >&nbsp;</div>
            ...
            <div id="wgt-box-extsrch-{$this->context}-{$this->searchKey}" class="wcm wcm_ui_search_builder wgt-space" style="height:300px;" >
            	...
            	<div class="wgt-panel" >
            	  ...
            	  <div class="inline bw25" >
            	    <label>Filter Name:</label> <input
            	      ...
            	      value="" /><button
            	        class="wgt-button append wa_reset_filter" ><i class="fa fa-trash" ></i></button>
            	  </div>
              	<div class="right" >
              		<button class="wgt-button wa_save_filter" ><i class="fa fa-save" ></i> Save filter</button>
              	</div>
            	</div>
              ...
              <div class="inline">&nbsp;&nbsp; <button class="wa_add_line wgt-button" ><i class="fa fa-plus-circle"></i></button></div>
          ...
          <div class="full wgt-space" style="text-align:right" >
          	<button class="wgt button wgtac_search" ><i class="fa fa-search" ></i> Search</button>
          </div>
