 ...
 */
class WgtPanelCard_Splitbutton extends WgtPanelCard
{
/* //////////////////////////////////////////////////////////////////////////// */
// panel methodes
/* //////////////////////////////////////////////////////////////////////////// */
    ...
    public function panelMenu()
    {
        ...
        if ($this->title) {
            ...
            if ($this->buttons) {
                ...
                $title .= '<div class="inline third" style="min-width:200px;text-align:center;"  >'.'<h2 style="margin-bottom:0px;" >'.$this->title.'</h2></div>';
            } else {
        ...
        if ($this->searchKey) {
            ...
            if ($this->filterPanel) {
                ...
                $codeFilter = "<span class=\"wcm wcm_ui_tip-top wgt-corner\" style=\"padding:3px 6px;\"  >"." <span id=\"wgt-search-table-{$this->searchKey}-numfilter\" >{$this->filterPanel->numFilterActive}</span> ".$i18n->l('active filters', 'wbf.label')." <a><i class=\"icon-close\" ></i></a></span>";
            }
      ...
      <div class="right" >
        ...
        <var id="wgt-search-table-{$this->searchKey}-control-reset-docu" >{$i18n->l('Reset the search form', 'wbf.label')}</var>
        <var id="wgt-search-table-{$this->searchKey}-control-reset-filter" >{$i18n->l('Unset all filters', 'wbf.label')}</var>
      ...
      <div class="wgt-dropdownbox" id="wgt-search-table-{$this->searchKey}-dropbox"  >
        <ul>
          ...
          <li><a
            ...
            wgt_doc_cnt="wgt-search-table-{$this->searchKey}-control-docu_cont"
            class="wcm wcm_ui_docu_tip" >
            <i class="fa fa-times"></i> {$i18n->l('Unset all filters', 'wbf.label')}
          </a></li>
        </ul>
        {$htmlFilters}
        <ul>
...
} // end class WgtPanelCard_Splitbutton
