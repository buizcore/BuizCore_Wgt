...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  /**
   * Die Actions welche im Listenmenü angezeigt werden sollen
   * @var array
   */
  public $actions = array() ;

  /**
   * Actions welche als Button vor dem Menü angezeigt werden sollen
   * @var array
   */
...
/*////////////////////////////////////////////////////////////////////////////*/
   ...
   * @return void
   */
  public function setBtnActions($action, $key = 'default')
  {

    if ($this->bTypeSingle)
      $this->btnActions = $action;
    else
      $this->btnActions[$key] = $action;

  }//end public function setBtnActions */
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  protected function loadMenuBuilder($key = 'default')
  {
    ...
    $conf = $this->getConf();
    if (!$mType = $conf->getStatus('grid_controls')) {
    ...
    if ($this->bTypeSingle) {
      ...
      $this->menuBuilder->btnActions = $this->btnActions;
      ...
      $menuBuilder->btnActions = $this->btnActions;
  ...
  protected function buildButton($button, $id = null, $value = null, $accessFunc = null)
  {
    ...
    if ($button[Wgt::BUTTON_TYPE] == Wgt::ACTION_AJAX_GET) {
      ...
      $html .= '<button '
        .' onclick="$R.del(\''.$url.'\',{confirm:\''.$this->i18n('Please confirm to delete this entry.','wbf.label').'\'});return false;" '
        .' class="'.$button[Wgt::BUTTON_PROP].'" '
        .' title="'.$this->view->i18n->l($button[Wgt::BUTTON_LABEL],$button[Wgt::BUTTON_I18N]).'" >'.
          Wgt::icon($button[Wgt::BUTTON_ICON] ,'xsmall', $button[Wgt::BUTTON_LABEL])
