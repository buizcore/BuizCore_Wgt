 ...
 */
class WgtList_Element extends WgtList
{
/*////////////////////////////////////////////////////////////////////////////*/
...
/*////////////////////////////////////////////////////////////////////////////*/
     ...
     */
    public function __construct($name = null, $view = null, $parentKey = null)
    {
        $this->name = $name;
        ...
        if (! $parentKey && $this->view) {
            $parentKey = $this->view->getIdKey();
        }
        $this->parentMask = $parentKey;
...
/*////////////////////////////////////////////////////////////////////////////*/
    ...
    public function menuCharFilter()
    {
        ...
        $html .= '<a class="'.$class.'" href="b=" ><i class="fa fa-minus-circle" ></i></a>';
        $html .= '</span>';
    ...
    /**
     * @deprecated use buildListElemFooter
     * @return string
     */
    public function buildTableFooter()
    {
        $html = ' <div class="wgt-panel footer wgt-border-top" >';
     ...
     * @return string
     */
    public function buildListElemFooter()
    {
        $html = ' <div class="wgt-panel footer wgt-border-top" >';
        $html .= '  <div class="right menu"  >';
        $html .= $this->menuTableSize();
        ...
        return $html;
    } // end public function buildListElemFooter */
    ...
    public function buildHtml()
    {
        ...
        if ($this->insertMode) {
            ...
            $this->html .= '<table id="'.$this->id.'-table" class="wgt-table '.$classes.'" style="table-layout: fixed;" >'.NL;
