    ...
    foreach ($actions as $action) {
      ...
      if (isset($button[Wgt::BUTTON_ACCESS])) {
        ...
        if (isset($row['acl-level']  )) {
          ...
          if (  isset($button[Wgt::BUTTON_MAX_ACCESS]) 
                    && $row['acl-level'] >= $button[Wgt::BUTTON_MAX_ACCESS]) {
            continue;
          }
        ...
        // prüfen auf globale rechte
          ...
          if (isset($button[Wgt::BUTTON_MAX_ACCESS]) 
                && $this->access->level >= $button[Wgt::BUTTON_MAX_ACCESS]) {
            continue;
          }
    ...
    foreach ($this->actions as $action) {
      ...
      if (isset($this->buttons[$action])) {
        ...
        if (isset($button[Wgt::BUTTON_ACCESS])) {
          ...
          } elseif ($this->access) {  // prüfen auf globale rechte
    ...
    if ($button[Wgt::BUTTON_TYPE] == Wgt::ACTION_AJAX_GET) {
      ...
      if ($id) {
        ...
        $html .= '<button '
          ...
          .'title="'.$displayLabel.'" >'
          .$displayIcon
          .($this->renderLabel ? ' '.$displayLabel:'').'</button>'; // ' '.$button[Wgt::BUTTON_LABEL].
