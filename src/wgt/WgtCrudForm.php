...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  /**
   * Suffix zum verhindern von Namenskonflikten innerhalb offener Masken / Tabs
   * Wird in Filtern verwendet
   * @var string
   */
  public $filterSuffix = null;
  ...
  /**
   * Die Daten des Formulars als array
   * kann bequem nach json serialisiert werden
   * @var array
   */
  public $jData = array();
...
// ACLS
   ...
   * @param string $formId
   */
  public function setPlainFormTarget($formAction, $formId)
  {
      $this->assignedForm = $formId;
      $this->targetUrl = $formAction;
  
  }//end public function setPlainFormTarget */

  /**
   * @param string $method
   * @param boolean $saveSeparate soll das form bei Maintab Save gespeichert werden?
   *
   */
  public function formTag($method = 'post', $saveSeparate = false)
  {

    $subRequest = '';
    if (!$this->readOnly && !$saveSeparate)
...
CODE;
    ...
    }//end public static function formId */
...
/*////////////////////////////////////////////////////////////////////////////*/
   ...
   *
   */
  protected function customizeData()
  {
