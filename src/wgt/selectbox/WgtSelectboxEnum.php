...
HTML;
    ...
    if ($this->inpOnly) {
        ...
        $html = '<div id="wgt_box_'.$this->attributes['id'].'" class="box-form-node is-standalone" >'
            .'<div class="box-form-node-element" >'.$select.'</div>'
            .'</div>'.NL;
        
    } else {
        
        $html = '<div id="wgt_box_'.$this->attributes['id'].'" class="box-form-node" >
      <div class="box-form-node-label" ><label  for="'.$this->attributes['id'].'" >'.$this->label.' '.$required.'</label>'.$helpIcon.'</div>
      <div class="box-form-node-element" >'.$select.'</div>
    </div>'.NL;
