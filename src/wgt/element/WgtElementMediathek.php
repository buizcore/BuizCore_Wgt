...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  public function __construct($name = null, $view = null)
  {
    ...
    // setup der icons
    $this->icons['delete'] = '<i class="fa fa-times-sign" ></i>';
    $this->icons['add'] = '<i class="fa fa-plus-circle" ></i>';
    $this->icons['search'] = '<i class="fa fa-search" ></i>';
  ...
  <div class="wgt-panel" >
    <div class="left" >
     ...
     <div
       ...
       data-tab-body="wgt-tab-mediathek-{$idKey}-content" >
       <div class="tab_head" >
         {$htmlTabs}
       </div>
     </div>
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  protected function renderImageTab($idKey)
  {
    ...
    $html = <<<HTML
    <div class="content" wgt_key="image" id="wgt-tab-mediathek-{$idKey}-content-image" >
...
HTML;
  ...
  public function renderImageEntry($elemId, $entry, $counter = null)
  {
    ...
    <tr
      ...
      data-url="{$this->urls['image_edit']}&amp;media={$this->mediaId}&amp;element={$elemId}&amp;objid={$entry['img_id']}" >
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  protected function renderFileTab($idKey)
  {
    ...
    $html = <<<HTML
    <div class="content" wgt_key="file" id="wgt-tab-mediathek-{$idKey}-content-file" >
...
HTML;
  ...
  public function renderFileEntry($elemId, $entry, $counter = null)
  {
    ...
    <tr
      ...
      data-url="{$this->urls['file_edit']}&amp;media={$this->mediaId}&amp;element={$elemId}&amp;objid={$entry['file_id']}" >
    ...
    <tr
      ...
      data-url="{$this->urls['image_edit']}&amp;media={$this->mediaId}&amp;element={$elemId}&amp;objid={$entry['file_id']}" >
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  protected function renderDocumentTab($idKey)
  {
    ...
    $html = <<<HTML
    <div class="content" wgt_key="image" id="wgt-tab-mediathek-{$idKey}-content-document" >
...
HTML;
  ...
  public function renderDocumentEntry($elemId, $entry, $counter = null)
  {
    ...
    <tr
      ...
      data-url="{$this->urls['document_edit']}&amp;media={$this->mediaId}&amp;element={$elemId}&amp;objid={$entry['doc_id']}" >
      <td class="pos" rowspan="2" valign="top" >{$counter}</td>
      <td rowspan="2" valign="top" >{$link}</td>
      <td>{$linkDownload}</td>
      <td>
