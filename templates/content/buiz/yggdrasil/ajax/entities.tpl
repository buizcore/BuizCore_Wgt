...
<li id="wgt-tree-buiz_yggdrasil-entity-<?php echo $entity['rowid'] ?>" class="closed loadable wgt-treenode"  >
  <span class="folder" ><?php echo $iconEntity.' '.$entity['name'] ?></span>
  <a class="wcm wcm_req_mtab" href="maintab.php?c=Buiz.Entity.edit&amp;objid=<?php echo $entity['rowid'] ?>" ><?php echo $iconEdit ?></a>
