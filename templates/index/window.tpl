...
<div
  class="box-template wgt-editlayer border"
  contenteditable="true"
  id="wgt-edit-field-text" ></div>
<div
  class="box-template wgt-editlayer number border"
  contenteditable="true"
  id="wgt-edit-field-number"  ></div>
<div
  class="box-template wgt-editlayer"
...
<div
  ...
  id="wgt-edit-field-time" ><input
    ...
    style="border:0px;width:100%;margin:0px;padding:0px;overflow:hidden;"
      /></div>
<div class="box-template wgt-editlayer border" contenteditable="true" id="wgt-edit-field-money" ><input
  type="text"
  style="border:0px;width:100%;margin:0px;padding:0px;"
  /><button
    class="wgt-button append-inp just-annotate"
    tabindex="-1"  ><i
      class="fa fa-money" ></i></button></div>
...
<tr>
	...
	<td class="cntrl" style="text-align:right;" >
		<button
			class="wa_search_add wgt-button" ><i class="fa fa-plus-circle" ></i></button><button
				class="wa_remove_line wgt-button" ><i class="fa fa-times-sign" ></i></button>
	</td>
</tr>
</script>
