    ...
    editor.on('init', function() {
        ...
        function applyList(listName) {
            ...
            tinymce.each(getSelectedTextBlocks(), function(block) {
                var listBlock, listRootBlock, sibling;
                ...
                if (sibling && isListNode(sibling) && sibling.nodeName == listName) {
                    ...
                    if(block.nodeName.toUpperCase() == 'DIV' ){
                        listRootBlock = dom.create(listName);
                        listBlock = dom.create(listItemName);
                        block.appendChild(listRootBlock);
                        listRootBlock.appendChild(listBlock);
                    } else {
