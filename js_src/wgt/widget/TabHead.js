    ...
    init: function(  ){
      ...
      */
      ...
      el.find( 'a.tab' ).bind( 'click.tab_head', function(){
        ...
        console.log('show '+el.attr('id')+' '+tabNode.attr('data-tab') );
        
        var contentHead = el.parentX('.wgt-content-head');
        if(contentHead){
            contentHead.find('.tabbed-box').hide();
            contentHead.find('.box-'+tabNode.attr('data-tab')).show();
        }
