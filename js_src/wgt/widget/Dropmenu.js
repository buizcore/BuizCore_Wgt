  ...
  jQuery.widget( "wgt.dropdown", {
    ...
    _create: function() {
      ...
      var self = this,
        ge = this.element,
        opts = this.options,
        dropBoxId = ge.attr( 'data-drop-box' ),
      ...
      if( opts.triggerEvent ){
        ge.bind( opts.triggerEvent+'.dropmenu' ,function( event ){
    ...
    init: function( event ){
      ...
      */
      ...
      this.initFolding( ge, dropBox, event );
    ...
    setKeyCommands: function(  ge,  dropBox ){
      ...
      jQuery(document).bind( 'mousedown.dropmenu',function( evt ){
      ...
      jQuery(document).bind( 'keypress.dropmenu',  function(e) {
    ...
    removeKeyCommands: function(){
      ...
      jQuery(document).unbind( 'keypress.dropmenu' ).unbind( 'mousedown.dropmenu' );
    ...
    open: function( event ){
      ...
      if (opts.pos == 'mouse') {
          ...
          console.log('click x '+event.pageX+'click y '+event.pageY);
    ...
    close: function(){
      ...
      if( opts.closeScroll ){
        $D.scrollEvents[elem.attr( 'data-drop-box' )] = undefined;
      }

      $G.$D.requestCloseMenu = function(){};

      dropBox = jQuery( '#'+elem.attr( 'data-drop-box' )+'-init' );
    ...
    remove: function(){
      ...
      jQuery(document).unbind('keypress.dropmenu');
      jQuery( '#'+this.element.attr( 'data-drop-box' )+'-init' ).remove();
