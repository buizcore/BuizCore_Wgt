...
(function(jQuery){
  ...
  jQuery.fn.miniMenu = function( options ){
    ...
    $S(this).each( function(){
      ...
      opts = jQuery.extend(opts, jQuery.fn.miniMenu.defaults, options);
  ...
  jQuery.fn.miniMenu.open = function( target ){
    ...
    if (undefined !== opts.overlayStyle.height) {
      console.log('Overlay height: '+opts.overlayStyle.height);
      $overlay.height(opts.overlayStyle.height);
    }
    ...
    if (undefined !== opts.pos) {

      style.left = opts.pos.left+'px';
      style.top = opts.pos.top+'px';
    ...
    if (opts.top)
    {
        style.top = opts.top + 'px';
    }
    if (opts.right)
    {
        style.left = null;
        style.right = opts.right + "px";


    }
    //console.log(  style.left+" + "+oStyleW+" > " + winW );

    console.log(  "top "+style.top+" + "+style.left + " " + style.right);
