...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  */
  public function displayTab($areaId, $params)
  {
    ...
    $params->searchFormAction = 'index.php?c=Acl.Mgmt_Qfdu_User.search&dkey='
    ...
    $params->formId = 'wgt-form-'.$this->domainNode->aclDomainKey.'-acl-update';
     ...
     // create the form action
    $params->formActionAppend = 'ajax.php?c=Acl.Mgmt_Qfdu_User.append&dkey='.$this->domainNode->domainName;
