...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  public function createListItem($data, $access, $params  )
  {
    ...
    //$className = 'AclMgmt_Qfdu_Dset_Treetable_Element';

    $listObj = new AclMgmt_Qfdu_Dset_Treetable_Element
    (
      $this->domainNode,
    ...
    if ($params->ajax) {
      ...
      $tabPanel->searchKey = $this->domainNode->domainName.'_acl_tdset';
    }
...
WGTJS;
  ...
  public function listBlockGroups($userId, $dsetId, $context)
  {
    ...
    /**/
    $table = new AclMgmt_Qfdu_Dset_Treetable_Element
    (
      $this->domainNode,
      'listingQualifiedUsers',
      $this->view
...
WGTJS;
  ...
  public function listEntry($areaId, $access, $params, $insert)
  {
    ...
    $assignEntity = $this->model->getEntityBuizGroupUsers();

    $data = $this->model->getEntryBuizGroupUsers( $params);
