      ...
      <tr class="wcm wcm_ui_highlight row{$num} {$pRowid} wgt-border-top" id="{$rowid}"  >
        ...
        <td valign="top" class="ind1" >&nbsp;&nbsp;
          ...
          <a
            ...
            <i class="fa fa-user" ></i> {$row['user']}</a>
         ({$row['num_groups']})
       </td>
       <td colspan="2" ></td>
       {$navigation}
 ...
 <div id="{$this->id}-list-action" >
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    <ul>
      ...
      <li><a
        target="_document"
        href="document.php?c=Acl.Mgmt_Qfdu_Dset.export&amp;dkey={$this->domainNode->domainName}" ><i class="fa fa-file-text-alt" ></i> Export</a></li>
    </ul>
   </div>
