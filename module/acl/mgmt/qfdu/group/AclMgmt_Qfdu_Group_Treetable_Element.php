  ...
  public function buildTbody()
  {
    ...
    foreach ($this->data as $row) {
      ...
      $body .= '<td valign="top" colspan="3" >'
        ...
        . $row['role_group_name'].' ('.$row['group_assignments'].') <i class="fa fa-group" ></i>'
        . '</td>'.NL;
      ...
      if (true) {
        ...
        $body .= '<td valign="top" class="ind1" >&nbsp;&nbsp;'
          ...
          . '<a
              ...
              href="modal.php?c=Buiz.ContactForm.formUser&amp;user_id='
                .$row['role_user_rowid'].'&amp;d_src='.$this->domainNode->domainName.'" >'
                .$row['user']
                .' ('.$row['num_dsets'].') <i class="fa fa-user" ></i>'
                .'</a>'
                .'</td>'.NL;
        ...
        $body .= '<td valign="top" >'
          .'<input
            ...
            id="wgt-input-acl-'.$this->domainNode->aclDomainKey.'-qfdu-'.$objid.'-date_start"
        ...
        $body .= '<td valign="top" >'
          .'<input
            type="text"
            class="'.$this->editForm.' wcm wcm_ui_date show small"
            id="wgt-input-acl-'.$this->domainNode->aclDomainKey.'-qfdu-'.$objid.'-date_end"
  ...
  public function renderDsetBlock($groupId, $userId, $context)
  {
    ...
    foreach ($this->dataEntity as $row) {
      ...
      $body .= '<td valign="top" class="ind2" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
        ...
        .' class="wcm wcm_req_ajax" >'.$row['dset_text'].' <i class="fa fa-file-alt" ></i></a></td>'.NL;
 ...
 <div id="{$this->id}-list-action" >
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    <ul>
      ...
      <li><a
        target="_document"
        href="document.php?c=Acl.Mgmt_Qfdu_Group.export&amp;dkey={$this->domainNode->domainName}" ><i class="fa fa-file-text-alt" ></i> Export</a></li>
    </ul>
   </div>
