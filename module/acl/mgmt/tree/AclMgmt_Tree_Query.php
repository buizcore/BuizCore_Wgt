...
SQL;
 ...
 /**
  ...
  public function fetchAccessTree($areaKey, $idGroup, $params = null)
  {
    ...
    $sql = <<<SQL
SELECT
  access_level from buiz_security_access
  WHERE
    id_area = {$areaKey}
...
(
  ...
  JOIN
    buiz_security_area_type
      ON buiz_security_area_type.rowid = child.id_type
        and upper(buiz_security_area_type.access_key) IN(upper('mgmt_reference'), upper('mgmt_element'))
