  ...
  <div class="wgt-panel" >
    ...
    <div class="inline" style="margin-left:20px;" >
      ...
      <button
        ...
        onclick="$R.get('modal.php?c=Buiz.RoleUser.selection&input=<?php echo $VAR->domain->aclDomainKey ?>-acl-dset-id_user');return false;"    >
     ...
     <div class="inline" style="margin-left:20px;" >
      ...
      <button
        ...
        <i class="fa fa-link" ></i> <?php echo $I18N->l( 'Append', 'wbf.label' );?>
      </button>
    </div>
