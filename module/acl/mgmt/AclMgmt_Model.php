 ...
 * @author Dominik Bonsch <d.bonsch@buizcore.com>
 */
class AclMgmt_Model extends MvcModel
{
/*////////////////////////////////////////////////////////////////////////////*/
// Attributes
/*////////////////////////////////////////////////////////////////////////////*/
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  */
  ...
  public function getAreaId()
  {
    ...
    $orm = $this->getOrm();
    $area = $orm->getByKey('BuizSecurityArea', $this->domainNode->aclKey);
    
    if ($area) {
        return $area->getid();
    } else {
        throw new Security_Exception('Missing security-area '.$this->domainNode->aclKey);
    }
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  public function fetchConnectData($params)
  {
    ...
    if($area){
      $entityBuizSecurityAccess->id_area = $acl->resources->getAreaId($area);
    }

    $areaId = $httpRequest->data('security_access',Validator::CKEY,'id_area');

    if($areaId){
      $entityBuizSecurityAccess->id_area = $areaId;
    }
  ...
  public function connect( $params)
  {
    ...
    try {
      ...
      $entityBuizSecurityAccess->access_level = 1;
      $entityBuizSecurityAccess->ref_access_level = 1;
      $entityBuizSecurityAccess->message_level = Acl::DENIED;
      $entityBuizSecurityAccess->priv_message_level = Acl::DENIED;
      $entityBuizSecurityAccess->meta_level = Acl::DENIED;
  ...
  public function deleteGroup( $groupId)
  {
    ...
    $orm->delete('BuizSecurityAccess', $groupId  );
