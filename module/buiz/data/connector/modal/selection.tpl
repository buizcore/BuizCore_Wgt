<form 
  ...
  method="get"
  action="ajax.php?c=Buiz.DataConnector.search&elid=wgt-grid-data-selector-table&cbe=<?php echo $VAR->rqt->cbElement; ?>" ></form>
    ...
    <div class="right" >
      <input 
        ...
        class="xlarge fparam-wgt-form-data-selector-search" /><button 
          ...
          onclick="$R.form('wgt-form-data-selector-search');" ><i class="fa fa-search" ></i></button>
    </div>
  </div>
