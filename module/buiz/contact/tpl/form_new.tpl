...
$cntForm = new WgtFormBuilder(
  $this,
  'ajax.php?c=Buiz.Contact.insert',
  'buiz-contact-create',
  'post'
);
$cntForm->form();
...
<fieldset class="wgt-space bw62" style="height:530px;" >
  ...
  <div class="do-clear small wgt-border-bottom" style="width:96%;margin:0px auto;" >&nbsp;</div>
  ...
  <div class="bw3 inline" >
    <div class="bw3 left" >
      ...
      <div class="right" ><button class="wgt-button" ><i class="fa fa-plus-circle" ></i></button></div>
    </div>
  ...
  <div class="bw61 left alr" style="text-align:right;" >
    <button
      class="wgt-button" ><i class="fa fa-times" ></i> Cancel</button>
    |
    <?php $cntForm->submit( '<i class="fa fa-save" > </i> Create Contact', '$S.modal.close();' ); ?>
  </div>
