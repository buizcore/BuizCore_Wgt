...
(
  $this,
  'ajax.php?c=Buiz.ContactForm.sendDsetMessage&amp;refid='.$VAR->refId.'&amp;element='.$VAR->elementKey,
  ...
  <div class="wgt-input-list" >
    ...
    <ul 
      ...
      <li id="wgt-contact_form-dset-<?php echo $user->id ?>" >
        ...
        <div><button 
          class="wgt-button"
          onclick="$S('#wgt-contact_form-dset-<?php echo $user->id ?>').remove();" ><i class="fa fa-times" ></i></button></div>
        <input 
          type="hidden" 
