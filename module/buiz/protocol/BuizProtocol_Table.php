 ...
 * @author Dominik Bonsch <d.bonsch@buizcore.com>
 */
class BuizProtocol_Table extends WgtTable
{
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  public function buildProtocolEntityHtml()
  {
    ...
    $head .= '<th>
      ...
      <span class="label" >'.$this->view->i18n->l('context','buiz.protocol_message.label.table_head_context').'</span>
    </th>'.NL;
    $head .= '<th>
      <span style="float:right" >
        <img style="text-align:right;" class="wgt-table_menu" src="'.View::$iconsWeb.'xsmall/control/sort_menu.png" />
      </span>
      <span class="label" >'.$this->view->i18n->l('message','buiz.protocol_message.label.table_head_message').'</span>
    </th>'.NL;
    ...
    foreach ($this->data as $key => $row) {
      ...
      $objid = $row['buiz_protocol_message_'.Db::PK];
      ...
      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['buiz_protocol_message_context']).'</td>'.NL;
...
}//end class WgtTableBuizProtocol
