 ...
 * @author Dominik Bonsch <d.bonsch@buizcore.com>
 */
class BuizProtocol_Table_Element extends WgtTable
{
/*////////////////////////////////////////////////////////////////////////////*/
// Attributes
/*////////////////////////////////////////////////////////////////////////////*/
   ...
   * @var string $id
   */
  public $id = 'wgt_table-buiz_protocol';

  /**
   * the most likley class of a given query object
   *
   * @var BuizProtocolAccess_Table_Query
   */
  public $data = null;
   ...
   */
  public $namespace = 'BuizProtocolAccess';
  ...
  */
  public function loadUrl()
  {
    ...
    (
      ...
      (
        Wgt::ACTION_PAGING ,
        'index.php?c=Buiz.ProtocolAccess.search&amp;target_mask=BuizProtocolAccess&amp;ltype=table'
      ),
