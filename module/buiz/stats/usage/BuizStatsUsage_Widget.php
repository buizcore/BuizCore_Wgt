 ...
 *
 */
class BuizStatsUsage_Widget extends WgtWidget
{
/*////////////////////////////////////////////////////////////////////////////*/
// Attributes
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  /**
   * @var BuizStatsUsage_Widget_Query
   */
  ...
  public function render($tabId, $tabSize = 'medium')
  {
    ...
    <div id="{$tabId}" class="wgt_tab {$tabSize}" title="Entity Chart"  >
      ...
      <div class="wcm wcm_chart_area" id="{$tabId}_graph" style="width:{$this->width}px;height:{$this->height}px;" >
        ...
        <div  class="content inline" id="{$tabId}_container" style="width:{$boxWidth}px;height:{$this->height}px;" ></div>
      </div>
