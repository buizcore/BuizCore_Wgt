 ...
 * @author Dominik Bonsch <d.bonsch@buizcore.com>
 */
class BuizExport_Controller extends MvcController_Domain
{
/*////////////////////////////////////////////////////////////////////////////*/
// Attributes
/*////////////////////////////////////////////////////////////////////////////*/
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  public function service_list($request, $response)
  {
    ...
    /* @var $model BuizCoreExport_Model  */
    $model = $this->loadDomainModel($domainNode, 'BuizExport');
  ...
  public function service_refList($request, $response)
  {
    ...
    /* @var $model BuizCoreExport_Ref_Model  */
    $model = $this->loadDomainModel($domainNode, 'BuizExport_Ref');
