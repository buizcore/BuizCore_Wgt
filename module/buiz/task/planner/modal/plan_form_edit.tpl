...
(
  $this,
  'ajax.php?c=Buiz.TaskPlanner.updatePlan&objid='.$this->plan,
  'wgt-form-wbf-taskplanner-edit-'.$this->plan,
  'post'
);
$planForm->form();

$iconDel = $this->icon( 'fa fa-times', "Delete" );
...
<div class="wgt-layout-grid bw62" >
  ...
  <div>
    <div class="left" >
      ...
      if($this->task->status != ETaskStatus::DELETED) {
      $planForm->checkbox
      (
        'Active',
        'task[status]',
...
<div class="do-clear small sep-bottom" >&nbsp;</div>
<div class="do-clear small" >&nbsp;</div>
  ...
  <div class="wgt-box-dateplanner-series  bw6" >
    ...
    <div class="wgt-box-dateplanner-advanced left bw62" wgt_hidden="true" >
      ...
      (
        ...
        'BuizTaskPlanner_Type_Selectbox',
        ETaskType::$labels,
        $this->schedule->type
      ); ?>
    </div>
...
<div>
  ...
  or <span onclick="$S.modal.close();" class="is-clickable" >Cancel</span>
</div>
