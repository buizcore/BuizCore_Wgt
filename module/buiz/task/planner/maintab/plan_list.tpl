...
<form 
  ...
  method="get"
  target="ajax.php?c=Buiz.TaskPlanner.search" ></form>
  ...
  <table 
    ...
    <thead>
      <tr>
        ...
        <th style="width:130px;" >Last Status</th>
    ...
    <tbody>
      <?php foreach( $this->plans as $pos => $plan ){ ?>
        ...
        <tr 
          ...
          wgt_url="modal.php?c=Buiz.TaskPlanner.editPlan&objid=<?php echo $plan['id'] ?>" >
          ...
          <td><?php echo ETaskStatus::label($plan['status']) ?></td>
