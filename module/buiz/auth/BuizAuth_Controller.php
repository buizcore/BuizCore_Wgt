 ...
 * @author Dominik Bonsch <d.bonsch@buizcore.com>
 */
class BuizAuth_Controller extends Controller
{
/*////////////////////////////////////////////////////////////////////////////*/
// Attributes
/*////////////////////////////////////////////////////////////////////////////*/
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  public function service_form($request, $response)
  {
    ...
    $this->view->setTitle(Conf::status('default_title').' Login');
    $this->view->setIndex('login');
    $this->view->setTemplate('buiz/auth/form_login', true  );
  ...
  public function service_login($request, $response)
  {
    ...
    /* @var $model BuizAuth_Model */
    $model = $this->loadModel('BuizAuth');
    ...
    if ($auth->login()) {
      ...
      if ($user->login($authRole)) {
        ...
        BuizCore::getInstance()->redirectToDefault();
  ...
  public function service_formResetPasswd($request, $response)
  {
    ...
    $this->view->setTemplate('buiz/auth/form_reset_pwd', true  );
  ...
  public function service_formChangePasswd($request, $response)
  {
    ...
    $this->view->setTemplate('buiz/auth/form_change_pwd', true  );
  ...
  public function service_formForgotPasswd($request, $response)
  {
    ...
    $this->view->setTemplate('buiz/auth/form_forgot_pwd', true  );
  ...
  public function service_forgotPasswd($request, $response)
  {
    ...
    $view = $response->loadView(
      'buiz_auth-forgot_passwd',
      'BuizAuth_ForgotPasswd'
    );
