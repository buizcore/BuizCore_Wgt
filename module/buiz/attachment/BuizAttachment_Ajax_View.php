 ...
 * @author Dominik Bonsch <d.bonsch@buizcore.com>
 */
class BuizAttachment_Ajax_View extends LibViewAjax
{
/*////////////////////////////////////////////////////////////////////////////*/
// display methodes
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  \$S('table#wgt-grid-attachment-{$context->element}-table').grid('update').grid('incEntries');
...
WGTJS;
  ...
  \$S('table#wgt-grid-attachment-{$context->element}-table').grid('update');
...
WGTJS;
  ...
  \$S('table#wgt-grid-attachment-{$context->element}-table').grid('update').grid('decEntries');
...
WGTJS;
  ...
  \$S('table#wgt-grid-attachment-{$context->element}-table').grid('update').grid('syncColWidth').grid('setNumEntries','{$numElem}');
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  \$S('table#wgt-grid-attachment-{$context->element}-storage-table').grid('update').grid('incEntries');
...
WGTJS;
  ...
  \$S('table#wgt-grid-attachment-{$context->element}-storage-table').grid('update');
...
WGTJS;
  ...
  \$S('table#wgt-grid-attachment-{$context->element}-storage-table').grid('update').grid('decEntries');
...
} // end class BuizAttachment_Ajax_View */
