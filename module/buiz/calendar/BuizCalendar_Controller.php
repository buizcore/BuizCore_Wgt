 ...
 * @author Dominik Bonsch <d.bonsch@buizcore.com>
 */
class BuizCalendar_Controller extends Controller
{
/*////////////////////////////////////////////////////////////////////////////*/
// methodes
/*////////////////////////////////////////////////////////////////////////////*/
...
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  */
  public function service_search($request, $response)
  {
    ...
    /* @var $model BuizCalendar_Model  */
    $model = $this->loadModel('BuizCalendar');

    // prüfen ob irgendwelche steuerflags übergeben wurde
    $params = new BuizCalendar_Search_Request($request );
    ...
    /* @var $view BuizCalendar_Ajax_View */
  ...
  */
  ...
  public function service_saveMessage($request, $response)
  {
    ...
    $rqtData = new BuizCalendar_Save_Request($request);
    $msgId = $request->param('objid',Validator::EID);
  ...
  */
  public function service_formForward($request, $response)
  {
    ...
    (
      ...
      'BuizCalendar_Forward',
      'displayForm'
    );
    $view->setModel($this->loadModel('BuizCalendar'));
...
} // end class BuizCalendar_Controller
