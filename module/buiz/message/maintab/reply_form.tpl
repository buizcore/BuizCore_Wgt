...
(
  $this,
  'ajax.php?c=Buiz.Message.sendReply&amp;objid='.$VAR->msgNode->msg_id.'&amp;element='.$VAR->elementKey,
...
<div class="bw62 wgt-space" >
  ...
  <div class="left wgt-content_box bw6 wgt-space">
    ...
    <div class="content bw6"  >
     <?php $cntForm->wysiwyg( 'Message', 'message', '<em>'.$VAR->msgNode->message.'</em>', [], array('plain'=>true)); ?>
    </div>
  </div>
