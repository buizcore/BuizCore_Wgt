<form
  ...
  id="wgt-form-buiz-groupware-search"
  action="ajax.php?c=Buiz.Message.searchList" ></form>

<div
  class="wgt-border-right"
  style="position:absolute;width:200px;top:0px;bottom:0px;left:0px;" >
  
  <div class="wgt-panel" ><button class="wgt-button wgtac_refresh" ><i class="fa fa-filter" ></i> Filter</button></div>
  ...
  <div id="wgt-tree-message-navigation" >
    <ul id="wgt-tree-message-navigation-tree" class="wgt-tree wgt-space" >
      ...
      <li><input
        ...
        name="channel[inbox]"
        class="fparam-wgt-form-buiz-groupware-search" /> <a><strong>Inbox</strong></a> /
        <input
          type="checkbox"
          <?php echo Wgt::checked(true, isset($VAR->settings->channels->outbox) )?>
          name="channel[outbox]"
          class="fparam-wgt-form-buiz-groupware-search" /> <a><strong>Outbox</strong></a>
        ...
        <ul>
          <li><input
            ...
            /> Messages <a class="wgt-mini-button" ><i class="fa fa-plus-circle" ></i> add</a></li>
          <li><input
            type="checkbox"
            name="aspect[]"
            ...
            class="fparam-wgt-form-buiz-groupware-search"
            /> Document <a class="wgt-mini-button" ><i class="fa fa-plus-circle" ></i> add</a></li>
          <li><input
            type="checkbox"
            name="aspect[]"
            ...
            class="fparam-wgt-form-buiz-groupware-search"
            /> Discussion <a class="wgt-mini-button" ><i class="fa fa-plus-circle" ></i> add</a></li>
          <li><input
            type="checkbox"
            name="aspect[]"
      ...
      <li><input
        ...
        class="fparam-wgt-form-buiz-groupware-search" /> <a><strong>Unsolicited</strong></a></li>
      <li><input
        type="checkbox"
        <?php echo Wgt::checked(true, isset($VAR->settings->channels->draft) )?>
        name="channel[draft]"
        class="fparam-wgt-form-buiz-groupware-search" /> <a><strong>Drafts</strong></a></li>
        <!--  
      <li><a href="#" ><strong>Templates</strong></a>
        <ul>
          <li><button class="wgt-button" ><i class="fa fa-plus-circle" ></i> Create Template</button></li>
        </ul>
      </li>-->
      <li><input
        type="checkbox"
        ...
        class="fparam-wgt-form-buiz-groupware-search" /> <a><strong>Archiv</strong></a>
      </li>
    </ul>
  </div>
</div>
...
<div id="wgt-message-list-content" >
  ...
  <div
    ...
    <div class="full" >
      <iframe
        src="plain.php?c=Buiz.Message.showMailContent&objid=<?php echo $VAR->message->msg_id; ?>"
