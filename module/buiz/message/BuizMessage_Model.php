 ...
 * @author Dominik Bonsch <d.bonsch@buizcore.com>
 */
class BuizMessage_Model extends MvcModel
{
/*////////////////////////////////////////////////////////////////////////////*/
// Attributes
/*////////////////////////////////////////////////////////////////////////////*/
...
/*////////////////////////////////////////////////////////////////////////////*/
   ...
   * @return array
   */
  public function fetchMiniListMessages($params)
  {

    $db = $this->getDb();


    /* @var $query BuizMessage_MiniList_Query */
    $query = $db->newQuery('BuizMessage_MiniList');
  ...
  }//end public function fetchMiniListMessages */
  ...
  public function fetchMessages($params)
  {
    ...
    /* @var $query BuizMessage_Table_Query */
    $query = $db->newQuery('BuizMessage_Table');
...
SQL;
  ...
  public function archiveMessage($messageId, $archive)
  {
    ...
    if ($archive)
      $queries[] = 'UPDATE buiz_message_receiver set status = '.EMessageStatus::ARCHIVED.' WHERE vid = '.$user->getId().' AND id_message = '.$messageId;
    else
      $queries[] = 'UPDATE buiz_message_receiver set status = '.EMessageStatus::OPEN.' WHERE vid = '.$user->getId().' AND id_message = '.$messageId;
