 ...
 * @author Dominik Bonsch <d.bonsch@buizcore.com>
 */
class BuizMessage_Reply_Maintab_View extends LibViewMaintab
{
/*////////////////////////////////////////////////////////////////////////////*/
// Methoden
/*////////////////////////////////////////////////////////////////////////////*/
  ...
  public function displayForm( $params)
  {
    ...
    $this->setTemplate('buiz/message/maintab/reply_form', true);
...
}//end class BuizMessage_Reply_Maintab_View
