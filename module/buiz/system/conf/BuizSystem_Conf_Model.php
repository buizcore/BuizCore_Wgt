 ...
 * @author Dominik Bonsch <d.bonsch@buizcore.com>
 */
class BuizSystem_Conf_Model extends MvcModel
{
/*////////////////////////////////////////////////////////////////////////////*/
// Attributes
/*////////////////////////////////////////////////////////////////////////////*/
...

{
  "settings": {
    ...
    "sys_name" : {
      "string",
      "Text",
      "Name of the basesystem BuizCore for free || BuizCore for commercial projects",
      "BuizCore",
      "true"
    },
    "sys_version" : {
    ...
    "gateway_name" : { "string",  "Text", "Name of the Gateway", "Buiz"  },
    "gateway_version" : { "string",  "Version", "Version string eg 1.0 or 1.0_RC", "" },
    "gateway.revision" : { "int",  "Int", "Revision counter", ""  },
    "gateway.api.version" : { "string",  "Version", "The API Version of the gateway", "" },
    "gateway_licence" : { "int",  "Int", "The Licence for the Gateway / Setup", ""  },
...
}//end class BuizSystem_Conf_Model */
