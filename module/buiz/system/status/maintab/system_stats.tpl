...
$iconBad = '<i class="fa fa-minus-circle" ></i>';
...
<div class="wgt-content_box inline wgt-space bw48" >
  <div class="head" ><h2>Caches</h2>
    <div class="right" >
      <a class="wcm wcm_req_del wgt-button " href="ajax.php?c=Buiz.Cache.CleanAll" >clean all</a>
    </div>
  </div>
  <div class="content" style="height:auto;" >
    <table class="wgt-table bw45" >
  ...
  <div class="head" ><h2>Metadata</h2>
    <div class="right" >
      <a
        ...
        href="modal.php?c=Buiz.Maintenance_Metadata.cleanAll" >clean all</a>
    </div>
  </div>
  <div class="content" style="height:auto;" >
  ...
  <div class="head" ><h2>Contexts</h2>
    <div class="right" >
      <a
        ...
        href="modal.php?c=Buiz.Context.resetAll" >clean all</a>
    </div>
  </div>
  <div class="content" style="height:auto;" >
    <table class="wgt-table wgt-space bw45" >
